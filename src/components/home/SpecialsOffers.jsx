const SpecialOffers = () => {
  return (
    <section className="special-offers">
      <section className="sections flex flex-col tablet:flex-row tablet:space-x-3 laptop:justify-around">
        <section className="section-1 w-full tablet:max-w-[400px]">
          <section className="hidden laptop:flex flex-wrap justify-between bg-blue-100 items-start rounded-lg p-3 shadow-cardShadow mb-2 desktop:h-[45.8%] min-h-[70px]">
          ...
          <section className="section-1__bottom my-3 p-3 rounded-lg shadow-cardShadow tablet:mt-0 tablet:min-h-[340px] laptop:min-h-[0]">
            ...
            <section className="products flex items-center justify-around mt-3 flex-wrap space-x-3">
              <section className="product-1 cursor-pointer">
                <section className="product-1__img bg-gray-200 rounded-full w-[100px] h-[100px] flex items-center justify-center">
                  <img
              ...
              <section className="product-2 cursor-pointer">
                <section className="product-2__img bg-gray-200 rounded-full w-[100px] h-[100px] flex items-center justify-center">
                  <img
              ...
              <section className="product-3 cursor-pointer">
                <section className="product-3__img bg-gray-200 rounded-full w-[100px] h-[100px] flex items-center justify-center">
                  <img
        ...
        <section className="section-2 w-full shadow-cardShadow my-3 rounded-lg p-3 tablet:mt-0 tablet:max-w-[400px]">
          ...
          <section className="offers grid grid-cols-2 space-x-2 space-y-2 items-center">
            <section className="1 col-span-1 flex flex-col items-center cursor-pointer">
              <img
            ...
            <section className="2 col-span-1 flex flex-col items-center cursor-pointer">
              <img
            ...
            <section className="3 col-span-1 flex flex-col items-center cursor-pointer">
              <img
            ...
            <section className="4 col-span-1 flex flex-col items-center cursor-pointer">
              <img
