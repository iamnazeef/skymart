const FlashPicks = () => {
  return (
    <section className="FlashPicks my-5 shadow-cardShadow p-3 rounded-lg tablet:mt-0 tablet:w-[50%] tablet:min-h-[420px] laptop:mt-4 laptop:w-[40%] laptop:min-h-[410px] desktop:w-[30%]">
      <section className="top flex items-center justify-between mb-3">
